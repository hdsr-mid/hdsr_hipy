...
def initialize_logger(logfile='hdsrhipy.log', level=logging.INFO, include_console=False):
    ...
    logging.info("Running hdsrhipy.")
    return logging

# def initialize_logger(name='hdsrhipy.log', path=r'D:\4569.10\python\log', log_level=20, fmt=FMT):
